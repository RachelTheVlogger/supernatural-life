...
const INTERACTIONS = {
  all: [
    { icon: Heart, text: 'Seduce them', category: 'seductive', explicit: true },
    { icon: Flame, text: 'Make them beg', category: 'menacing', explicit: true },
    { icon: Eye, text: 'Read their fear', category: 'mysterious', explicit: false },
    { icon: Zap, text: 'Show your power', category: 'menacing', explicit: false },
    { icon: Handshake, text: 'Propose a truce', category: 'bargain', explicit: false },
    { icon: Skull, text: 'Corner them', category: 'tactical', explicit: false },
    { icon: Heart, text: 'Play with them', category: 'seductive', explicit: true },
    { icon: Eye, text: 'Hypnotize them', category: 'mysterious', explicit: false },
  ],
  seductive: [
    { icon: Heart, text: 'Seduce them', category: 'seductive', explicit: true },
    { icon: Heart, text: 'Play with them', category: 'seductive', explicit: true },
    { icon: Flame, text: 'Let them taste your bite', category: 'seductive', explicit: true },
    { icon: Eye, text: 'Make them want you', category: 'seductive', explicit: true },
  ],
  menacing: [
    { icon: Flame, text: 'Make them beg', category: 'menacing', explicit: true },
    { icon: Zap, text: 'Show your power', category: 'menacing', explicit: false },
    { icon: Skull, text: 'Promise them death', category: 'menacing', explicit: false },
    { icon: Flame, text: 'Let them feel your hunger', category: 'menacing', explicit: true },
  ],
  tactical: [
    { icon: Skull, text: 'Corner them', category: 'tactical', explicit: false },
    { icon: Eye, text: 'Find their weakness', category: 'tactical', explicit: false },
    { icon: Zap, text: 'Exploit their fear', category: 'tactical', explicit: false },
    { icon: Handshake, text: 'Offer them a choice', category: 'tactical', explicit: false },
  ],
  mysterious: [
    { icon: Eye, text: 'Read their fear', category: 'mysterious', explicit: false },
    { icon: Eye, text: 'Hypnotize them', category: 'mysterious', explicit: false },
    { icon: Zap, text: 'Reveal a secret', category: 'mysterious', explicit: false },
    { icon: Heart, text: 'Show them your humanity', category: 'mysterious', explicit: false },
  ],
  bargain: [
    { icon: Handshake, text: 'Propose a truce', category: 'bargain', explicit: false },
    { icon: Handshake, text: 'Offer them immortality', category: 'bargain', explicit: false },
    { icon: Handshake, text: 'Make a blood pact', category: 'bargain', explicit: false },
    { icon: Eye, text: 'Negotiate for their silence', category: 'bargain', explicit: false },
  ],
};
