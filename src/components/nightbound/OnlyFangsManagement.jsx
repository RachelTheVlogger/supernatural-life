...
const VIDEO_CATEGORIES = {
  ...
  clothed: { label: 'Clothed/Lingerie', icon: '👙', examples: ['Lingerie try-on haul', 'Strip tease in lingerie', 'Modeling new outfits', 'Teasing in silk', 'Bra and panties showcase', 'Sensual but covered', 'Lace bodysuit reveal', 'Garter belt content'], minRep: 0 },
  softcore: { label: 'Softcore/Implied', icon: '🌸', examples: ['Covered nudity in bed', 'Implied touching under sheets', 'Suggestive poses', 'Sensual but not explicit', 'Implied pleasure faces', 'Seductive without showing', 'Artistic implied content', 'Strategic covering'], minRep: 0 },
  fashion: { label: 'Fashion/Modeling', icon: '👗', examples: ['Outfit showcases', 'Fashion modeling poses', 'Dress try-ons', 'Casual outfit videos', 'Street style content', 'Clothing hauls', 'Fashion lookbook', 'Styling tips'], minRep: 0 },
  workout: { label: 'Workout/Fitness', icon: '💪', examples: ['Gym outfit videos', 'Yoga poses and stretches', 'Exercise routines', 'Stretching content', 'Sports bra workouts', 'Fitness motivation', 'Athletic wear modeling', 'Flexibility showcase'], minRep: 0 },
  lifestyle: { label: 'Lifestyle/Vlog', icon: '📸', examples: ['Day in my life', 'Behind the scenes', 'Morning routine', 'Getting ready content', 'Q&A videos', 'Personal updates', 'Coffee and chat', 'Late night thoughts'], minRep: 0 },
  bath: { label: 'Bath/Spa', icon: '🛁', examples: ['Bath time tease', 'Bubble bath covered', 'Spa day content', 'Self-care routine', 'Relaxing in bubbles', 'Bath bombs and chill'], minRep: 0 },
  dance: { label: 'Dance/Movement', icon: '💃', examples: ['Sensual dancing', 'Twerk videos', 'Belly dancing', 'Pole dancing', 'Rhythmic movement', 'Dance routines'], minRep: 0 },
