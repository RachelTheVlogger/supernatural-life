...
export default function SextingSession({ servant, vampireState, onClose, onGainRelationship }) {
  ...
  const quickActions = heatLevel < 20 ? [
    ...
    { id: 'command', label: '👑 Command', text: 'Touch yourself. Tell me how wet you are.', action: 'command' },
    { id: 'video', label: '🎥 Request video', text: 'Record yourself touching yourself. Send it.', action: 'video' }
  ] : [
    { id: 'edge', label: '⚡ Make them edge', text: 'Get close. But don\'t cum yet.', action: 'edge' },
    { id: 'allow', label: '✅ Let them cum', text: 'Cum for me. Now.', action: 'command' },
    { id: 'deny', label: '🚫 Deny them', text: 'Stop. You\'re not allowed to cum yet.', action: 'edge' },
